...
namespace Compiler.Compilation.Intrinsics
{
    internal class Lookup : Intrinsic
    {
        ...
        internal override void CompileCall(Script script, Function function, RuleList rules, CallExpression cl, int? result_address, bool ref_result_address = false)
        {
            ...
            rules.AddAction($"up-modify-goal {script.Intr1} g:z/ {ScriptCompiler.Settings.MaxElementsPerRule - 2}");
            ...
            rules.AddAction($"up-modify-goal {script.Intr1} g:= {script.Intr0}");
            rules.AddAction($"up-modify-goal {script.Intr1} g:mod {ScriptCompiler.Settings.MaxElementsPerRule - 2}");
