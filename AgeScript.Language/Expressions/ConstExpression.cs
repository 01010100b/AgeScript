...
namespace AgeScript.Language.Expressions
{
    public class ConstExpression : Expression
    {
        ...
        public static ConstExpression FromInt(int value) => new() { ConstType = Primitives.Int, Int = value };
        public static ConstExpression FromBool(bool value) => new() { ConstType= Primitives.Bool, Bool = value };
        public static ConstExpression FromPrecise(float value) => new() { ConstType = Primitives.Precise, Precise = (int)Math.Round(value * 100) };
