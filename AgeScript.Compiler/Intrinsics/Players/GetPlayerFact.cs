...
namespace AgeScript.Compiler.Intrinsics
{
    internal class GetPlayerFact : Inlined
    {
        ...
        internal override void CompileCall(CompilationResult result, CallExpression cl, int? result_address = null, bool ref_result_address = false)
        {
            ...
            var player_name = cl.Arguments[0] is ConstExpression c0 && c0.Int == -1 ? "my-player-number" : "focus-player";
            ...
            result.Rules.AddAction($"up-get-player-fact {player_name} {ce1.Int} {ce2.Int} {result.Memory.Intr1}");
